...
var grammar = {
    ...
    {"name": "Modifier$subexpression$1$string$10", "symbols": [{"literal":"t"}, {"literal":"o"}, {"literal":"p"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$10"]},
    {"name": "Modifier$subexpression$1$string$11", "symbols": [{"literal":"r"}, {"literal":"i"}, {"literal":"g"}, {"literal":"h"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$11"]},
    {"name": "Modifier$subexpression$1$string$12", "symbols": [{"literal":"l"}, {"literal":"e"}, {"literal":"f"}, {"literal":"t"}], "postprocess": function joiner(d) {return d.join('');}},
