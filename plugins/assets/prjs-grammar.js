...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "ModuleList$macrocall$1$ebnf$1", "symbols": ["ModuleList$macrocall$1$ebnf$1", "ModuleList$macrocall$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "Script$string$1", "symbols": [{"literal":"s"}, {"literal":"c"}, {"literal":"r"}, {"literal":"i"}, {"literal":"p"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "Script$macrocall$2", "symbols": [{"literal":"("}, "_"]},
    {"name": "Script$macrocall$3$ebnf$1", "symbols": ["ParameterList"], "postprocess": id},
    {"name": "Script$macrocall$3$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "Script$macrocall$7$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "ParameterList$macrocall$1$ebnf$1", "symbols": ["ParameterList$macrocall$1$ebnf$1", "ParameterList$macrocall$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "StatementList$macrocall$1$ebnf$1", "symbols": ["StatementList$macrocall$1$ebnf$1", "StatementList$macrocall$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "Identifier$ebnf$1", "symbols": ["Identifier$ebnf$1", /[a-zA-Z_$0-9]/], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "Pause$string$1", "symbols": [{"literal":"p"}, {"literal":"a"}, {"literal":"u"}, {"literal":"s"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "Pause$ebnf$1", "symbols": [{"literal":";"}], "postprocess": id},
    {"name": "Pause$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "AddSay$string$1", "symbols": [{"literal":"a"}, {"literal":"d"}, {"literal":"d"}, {"literal":"s"}, {"literal":"a"}, {"literal":"y"}], "postprocess": (d) => d.join('')},
    {"name": "AddSay$ebnf$1", "symbols": [{"literal":";"}], "postprocess": id},
    {"name": "AddSay$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "Say$string$1", "symbols": [{"literal":"s"}, {"literal":"a"}, {"literal":"y"}, {"literal":"s"}], "postprocess": (d) => d.join('')},
    {"name": "Say$ebnf$1", "symbols": [{"literal":";"}], "postprocess": id},
    {"name": "Say$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "Show$string$1", "symbols": [{"literal":"s"}, {"literal":"h"}, {"literal":"o"}, {"literal":"w"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "Show$macrocall$1$ebnf$1", "symbols": ["Show$macrocall$1$ebnf$1", "Show$macrocall$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "Show$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "Move$macrocall$1$ebnf$1", "symbols": ["Move$macrocall$1$ebnf$1", "Move$macrocall$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "Move$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "Hide$string$1", "symbols": [{"literal":"h"}, {"literal":"i"}, {"literal":"d"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "Hide$macrocall$1$ebnf$1", "symbols": ["Hide$macrocall$1$ebnf$1", "Hide$macrocall$1$ebnf$1$subexpression$1"], "postprocess": (d) => d[0].concat([d[1]])},
    ...
    {"name": "Hide$ebnf$1", "symbols": [], "postprocess": () => null},
    ...
    {"name": "JS$macrocall$2$string$1", "symbols": [{"literal":"{"}, {"literal":"@"}], "postprocess": (d) => d.join('')},
    {"name": "JS$macrocall$2", "symbols": ["JS$macrocall$2$string$1", "_"]},
    {"name": "JS$macrocall$3$ebnf$1", "symbols": []},
    {"name": "JS$macrocall$3$ebnf$1", "symbols": ["JS$macrocall$3$ebnf$1", "CodeCharacter"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "JS$macrocall$3", "symbols": ["JS$macrocall$3$ebnf$1"]},
    {"name": "JS$macrocall$4$string$1", "symbols": [{"literal":"@"}, {"literal":"}"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "CodeCharacter$string$1", "symbols": [{"literal":"@"}, {"literal":"}"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "String$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"\\"}, {"literal":"`"}], "postprocess": (d) => d.join('')},
    ...
    {"name": "Modifier$subexpression$1$string$1", "symbols": [{"literal":"c"}, {"literal":"e"}, {"literal":"n"}, {"literal":"t"}, {"literal":"e"}, {"literal":"r"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$1"]},
    {"name": "Modifier$subexpression$1$string$2", "symbols": [{"literal":"i"}, {"literal":"n"}, {"literal":"v"}, {"literal":"i"}, {"literal":"s"}, {"literal":"i"}, {"literal":"b"}, {"literal":"l"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$2"]},
    {"name": "Modifier$subexpression$1$string$3", "symbols": [{"literal":"s"}, {"literal":"t"}, {"literal":"a"}, {"literal":"g"}, {"literal":"e"}, {"literal":"L"}, {"literal":"e"}, {"literal":"f"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$3"]},
    {"name": "Modifier$subexpression$1$string$4", "symbols": [{"literal":"l"}, {"literal":"e"}, {"literal":"f"}, {"literal":"t"}, {"literal":"2"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$4"]},
    {"name": "Modifier$subexpression$1$string$5", "symbols": [{"literal":"l"}, {"literal":"e"}, {"literal":"f"}, {"literal":"t"}, {"literal":"3"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$5"]},
    {"name": "Modifier$subexpression$1$string$6", "symbols": [{"literal":"r"}, {"literal":"i"}, {"literal":"g"}, {"literal":"h"}, {"literal":"t"}, {"literal":"2"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$6"]},
    {"name": "Modifier$subexpression$1$string$7", "symbols": [{"literal":"r"}, {"literal":"i"}, {"literal":"g"}, {"literal":"h"}, {"literal":"t"}, {"literal":"3"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$7"]},
    {"name": "Modifier$subexpression$1$string$8", "symbols": [{"literal":"s"}, {"literal":"t"}, {"literal":"a"}, {"literal":"g"}, {"literal":"e"}, {"literal":"R"}, {"literal":"i"}, {"literal":"g"}, {"literal":"h"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$8"]},
    {"name": "Modifier$subexpression$1$string$9", "symbols": [{"literal":"v"}, {"literal":"i"}, {"literal":"s"}, {"literal":"i"}, {"literal":"b"}, {"literal":"l"}, {"literal":"e"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$9"]},
    {"name": "Modifier$subexpression$1$string$10", "symbols": [{"literal":"t"}, {"literal":"o"}, {"literal":"p"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$10"]},
    {"name": "Modifier$subexpression$1$string$11", "symbols": [{"literal":"r"}, {"literal":"i"}, {"literal":"g"}, {"literal":"h"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$11"]},
    {"name": "Modifier$subexpression$1$string$12", "symbols": [{"literal":"l"}, {"literal":"e"}, {"literal":"f"}, {"literal":"t"}], "postprocess": (d) => d.join('')},
    {"name": "Modifier$subexpression$1", "symbols": ["Modifier$subexpression$1$string$12"]},
